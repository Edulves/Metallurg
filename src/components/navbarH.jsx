const NavbarH = ({ onNovaAnalise }) => {
    return (
        <header className="sticky top-0 z-50 h-16 border-b border-metallurg-surface-bright flex items-center justify-between px-6 bg-metallurg-navy ">
            ...
            <div className="flex items-center">
                <button onClick={onNovaAnalise} className="bg-metallurg-orange hover:bg-orange-600 text-white px-4 py-2 rounded text-sm font-semibold transition-colors flex items-center gap-2">
